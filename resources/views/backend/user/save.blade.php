                      ...
                      <fieldset class="p-3 border rounded">
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <x-input-label name="name" placeholder="Enter Your Name" label="Name" :value="old('name', ($data['name']) ?? '')"
                              :required="true" />
                          </div>
                          <div class="col-md-6 mb-3">
                            <x-select-label name="gender" label="Gender" :value="old('gender')" :options="__('data.gender')" />
                          ...
                          <div class="col-md-6 mb-3">
                            <x-input-label name="avatar" placeholder="Enter Your Avatar URL" label="Avatar"
                              :value="old('avatar')" :required="true" />
                          </div>
                          <div class="col-md-6 mb-3">
                            <x-input-label type="number" name="phone" placeholder="Enter Your Phone" label="Phone"
                          ...
                          <div class="col-md-6 mb-3">
                            <x-input-label type="date" name="date" placeholder="Enter Your Date of Birth"
                              label="Date of Birth" :value="old('date')" :required="true" />
                          </div>
                        </div>
                      </fieldset>
                    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 mb-3">
                            <x-input-label name="detail_address" placeholder="Enter Your Detailed Address"
                              label="Địa chỉ chi tiết" :value="old('detail_address')" :required="true" />
                          </div>
                          <div class="col-md-12 mb-3">
                            <x-textarea-label name="ghichu" label="Ghi Chú" :value="old('ghichu')" />
                          </div>
                        </div>
                      </fieldset>
                    </div>
